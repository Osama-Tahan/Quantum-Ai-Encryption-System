...
DEFAULT_ENCRYPTER_USERNAME=os.getenv('DEFAULT_ENCRYPTER_USERNAME','encrypter')
DEFAULT_ENCRYPTER_PASSWORD=os.getenv('DEFAULT_ENCRYPTER_PASSWORD','encrypt123')
...
@app.get("/api/admin/reset-default-users")
        ...
        "users": [
            {
                ...
                "hash_prefix": (u.password_hash or "")[:18]
            } for u in users
        ]
    }
